...
public class AreaNGTest {
    ...
    public void testSort() {
        ...
        assertEquals(lines.get(0).p1, new Point2D.Double(4, 1));
        assertEquals(lines.get(0).p2, new Point2D.Double(4, 7));
        assertEquals(lines.get(1).p1, new Point2D.Double(5, 6));
        assertEquals(lines.get(1).p2, new Point2D.Double(5, 13));
    }
    ...
    public void testAngleSort() {
        ...
        List<Line> lines = area.getLines();
        assertEquals(lines.get(0).p1, new Point2D.Double(2, 1));
        assertEquals(lines.get(0).p2, new Point2D.Double(5, 4));
        assertEquals(lines.get(1).p1, new Point2D.Double(0, 0));
        assertEquals(lines.get(1).p2, new Point2D.Double(9, 9));
        assertEquals(lines.get(2).p1, new Point2D.Double(7, 8));
        assertEquals(lines.get(2).p2, new Point2D.Double(8, 9));
    }
